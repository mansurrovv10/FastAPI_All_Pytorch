...
import uvicorn
from mysite.api import mnist,cifar10,fashion,flowers,foods
...
pytorch_app.include_router(flowers.flower_router)
pytorch_app.include_router(foods.foods_router)
